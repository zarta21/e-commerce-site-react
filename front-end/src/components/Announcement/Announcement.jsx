        ...
        <div className="center">
          {data?.loading
            ? data?.loading && data?.error 
                ? <span className='message'>An error occurred. Can't fetch data...</span>
                : <span className='message'>Please wait, fetching data from the server...</span>            
            : data?.products
              ...
              : <span className='message'>Something went wrong. Try again later</span>
          }
        </div>
        <div className="right">
          <div className="email">
